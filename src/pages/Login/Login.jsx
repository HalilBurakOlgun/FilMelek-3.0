    ...
    <div className='login'>
      ...
      <div className="login-form">
        ...
        <div className="form-switch">
          {signState==="Sign In"?<p>Buralarda yeni misin tatlım? <span onClick={()=>{setSignState("Sign Up")}}>Kayıt ol</span> </p>
          :<p>Hesabım var <span onClick={()=>{setSignState("Sign In")}}>Giriş yap</span> </p>}
